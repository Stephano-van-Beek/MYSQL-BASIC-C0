...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/database/sql&db=mod-mysql-basic-fifa2018
   ...
   Weergave van records 0 -  5 (6 totaal, Query duurde 0,0032 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/database/sql&db=mod-mysql-basic-fifa2018
   ...
   Weergave van records 0 - 24 (26 totaal, Query duurde 0,0028 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/database/sql&db=mod-mysql-basic-fifa2018
   ...
   Weergave van records 0 - 12 (13 totaal, Query duurde 0,0025 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/database/sql&db=mod-mysql-basic-fifa2018
   ...
   Weergave van records 0 - 24 (27 totaal, Query duurde 0,0033 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/database/sql&db=mod-mysql-basic-fifa2018
   ...
   Weergave van records 0 - 24 (27 totaal, Query duurde 0,0028 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/database/sql&db=mod-mysql-basic-fifa2018
   ...
   Weergave van records 0 -  4 (5 totaal, Query duurde 0,0031 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/database/sql&db=mod-mysql-basic-fifa2018
   ...
   Weergave van records 0 -  8 (9 totaal, Query duurde 0,0036 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/database/sql&db=mod-mysql-basic-fifa2018
   ...
   Weergave van records 0 - 24 (97 totaal, Query duurde 0,0033 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/database/sql&db=mod-mysql-basic-fifa2018
   ...
   Weergave van records 0 - 24 (42 totaal, Query duurde 0,0032 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/database/sql&db=mod-mysql-basic-fifa2018
   ...
   Weergave van records 0 - 15 (16 totaal, Query duurde 0,0037 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/database/sql&db=mod-mysql-basic-fifa2018
   ...
   Weergave van records 0 - 20 (21 totaal, Query duurde 0,0048 seconden.)
