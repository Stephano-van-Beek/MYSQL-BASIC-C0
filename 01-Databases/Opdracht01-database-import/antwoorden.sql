...
127.0.0.1/mod_mysql_basic_imdb_movies/movies/		http://localhost/phpmyadmin/index.php?route=/table/sql&db=mod_mysql_basic_imdb_movies&table=movies

   Showing rows 0 - 24 (98 total, Query took 0.0019 seconds.)
